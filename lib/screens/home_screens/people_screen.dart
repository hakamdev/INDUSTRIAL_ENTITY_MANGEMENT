...
import 'package:oqvt_industrial_entity_management/widgets/people_list_tile.dart';
import 'package:oqvt_industrial_entity_management/widgets/search_bar.dart';

class PeopleScreen extends StatefulWidget {
  const PeopleScreen({super.key, this.viewPadding});
      ...
      default:
        return SliverList.separated(
          itemBuilder: (context, index) {
            ...
            return Center(
              child: XPeopleListTile(
                index: index,
                name: person["name"],
                picture: person["picture"],
                role: person["role"],
                status: person["available"] ? "Available" : "Not Available",
                onPressed: () => onEquipmentPressed(person),
              ),
            );
          },
